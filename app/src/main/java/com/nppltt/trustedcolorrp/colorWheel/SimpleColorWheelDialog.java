...
package com.nppltt.trustedcolorrp.colorWheel;
...
import com.nppltt.trustedcolorrp.CustomViewDialog;
...
public class SimpleColorWheelDialog extends CustomViewDialog<SimpleColorWheelDialog> {
    ...
    private boolean NOColorExample = false;
    ...
    public SimpleColorWheelDialog color(int color, boolean noColorExample) {
        NOColorExample = noColorExample;
        return setArg(COLOR, color);
    }
